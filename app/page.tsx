    ...
    <section className="space-y-8">
      <header className="space-y-2 text-center">
        ...
        <p className="text-lg text-slate-300">
          Start building with the latest Next.js features, powered by TypeScript and
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <article className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-lg shadow-slate-950/50">
          ...
          <p className="mt-2 text-sm text-slate-300">
            Run <code className="rounded bg-slate-800 px-2 py-1">pnpm dev</code> to launch the
